...
public class LearningConfig {
	...
	static int TYPE_CONTROLLER = 4;
	static int TYPE_BLE_DEVICES = 5;
	...
	public void loadProperties() {
		...
		if(properties.getProperty("type") != null) {
			if(properties.getProperty("type").equalsIgnoreCase("smartcard"))
				...
				type = TYPE_TLS;
			else if(properties.getProperty("type").equalsIgnoreCase("controller"))
				type = TYPE_CONTROLLER;
			else if(properties.getProperty("type").equalsIgnoreCase("ble_devices"))
				type = TYPE_CONTROLLER;
		}
