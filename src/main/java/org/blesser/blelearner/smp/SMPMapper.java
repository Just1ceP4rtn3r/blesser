...
public class SMPMapper {
   ...
   * Input: fileds = "IOCap:0x05-OOBflag:0x00-AUTHReq:0x01-InitKeyDist:0x07-RespKeyDist:0x07"
   * Output: none
   */
  ...
  // TODO:override reset method to reset the connection
